...
item_table = {
    ...
    "Progressive Construction Construction": ItemData(21, ItemClassification.progression),
    "Progressive Social Construction": ItemData(22, ItemClassification.progression),
    "Progressive Digging Construction": ItemData(23, ItemClassification.progression),
